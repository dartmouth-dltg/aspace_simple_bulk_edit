...
class AspaceSimpleBulkEditHandler
  ...
  def self.update_ao_descendants(id, repo_id, new_tc_id, indicator_2, inst)
  ...
  def self.update_container_instance(ao_json, new_tc_id, indicator_2, inst)
  ...
  def self.simple_bulk_edit_create_container_instance(instance_type, tc_uri, child_ind = nil)
    instance = nil
    begin
